    ...
    <div class="card shadow">
        <div class="card-header border-0">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="mb-0">Editar Sala {{$sala->nombre}}</h3>
                </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ url('/salas/'.$sala->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nombre" class="form-control" value="{{old('nombre',$sala->nombre)}}" id="nombre" required>
                </div>
                <div class="form-group">
                    <label for="description">Descripción de la Sala</label>
                    <input type="text" name="description" class="form-control" id="description" value="{{old('description',$sala->description)}}">
                </div>
                <div class="form-group">
